...
## On choisit la resource que l'on veut et on spécifie le format souhaité[ xml ou json ]. 
puts liste_events
...
Nous suivre Sur Twitter :<a href="http://twitter.com/hassanemoustaph">@hassanemoustaph</a>
== Copyright
